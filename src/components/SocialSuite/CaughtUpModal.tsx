...
export function CaughtUpModal({ onClose }: CaughtUpModalProps) {
  ...
  return (
    <div className="caught-up-overlay" role="dialog" aria-modal="true" aria-label="Mindful Escape Portal">
      <div className="caught-up-modal">
        ...
        <div className="caught-up-header">
          ...
          <p className="caught-up-subline">
            {t('social.epoch.caughtUpSub')}
          </p>
        </div>
        ...
        <div className="breathing-station">
          ...
          <span className="breathing-caption">
            Box Breathing • 4-4-4-4 Nervous System Reset
          </span>
        </div>
        ...
        <div className="grounding-suggestions">
          ...
          <div className="grounding-item">
            ...
            <div className="grounding-text">
              ...
              <p>Drink a glass of water slowly or feel the temperature of the air on your wrists.</p>
            </div>
          </div>
          <div className="grounding-item">
            <span className="grounding-icon">🚶</span>
            <div className="grounding-text">
              ...
              <p>The screen has served its purpose. Real presence is waiting beyond your doorstep.</p>
            </div>
          </div>
        </div>
